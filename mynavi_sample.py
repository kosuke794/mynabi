...
# ファイルの名前を指定。
LOG_FILE_PATH = "./kadai02/log/log_###DATETIME###.log"
EXP_CSV_PATH="./kadai02/exp_list_###SEARCH_KEYWORD###_###DATETIME###.csv"
...
def set_driver(driver_path, headless_flg):
    ...
    options.add_argument('--incognito')          # シークレットモードの設定を付与これだけでも動作は可能。
